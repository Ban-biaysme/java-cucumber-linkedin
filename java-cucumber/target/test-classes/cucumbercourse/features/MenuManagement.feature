#Project start from feature file. file extension should be .feature

#Author: biyas.banerjee2013@gmail.com
#Keywords Summary : 
...
Given I have a menu item with name "Veg Sandwich" and price 10
When I add that menu item
